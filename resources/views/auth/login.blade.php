                  ...
                  <div class="col-lg-12"> 
                    <div class="card-body p-md-5 mx-md-4">
                      ...
                      <div class="text-center">
                        ...
                        <h4 class="mt-1 mb-5 pb-1">Nhận diện khuôn mặt</h4>
                      </div>
                      ...
                      <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-outline mb-4">
                          ...
                          <input type="email" name="email" id="form2Example11" class="form-control" placeholder="Vui lòng nhập email"/>
                          {{-- <label class="form-label" for="form2Example11">Email</label> --}}
                        </div>
      
                        <div class="form-outline mb-4">
                          <label class="my-label"><i class="fas fa-key"></i> Mật khẩu </label>
                          <input type="password" name="password" id="form2Example22" class="form-control" placeholder="Vui lòng nhập mật khẩu" />
                          {{-- <label class="form-label" for="form2Example22">Mật khẩu</label> --}}
                        </div>
      
                        <div class="text-center pt-1 mb-2 pb-1">
                          <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3 my-submit-btn" type="submit">Đăng nhập</button>
                          {{-- <a class="text-muted" href="#!">Forgot password?</a> --}}
                        </div>
      
                        <div class="d-flex align-items-center justify-content-center pb-4">
                          <p class="mb-0 me-2">Chưa có tài khoản?</p>
                          <a href="{{route('url.myregister')}}" class="a-outline-danger">Đăng ký ngay</a>
                        </div>
