...
<head>
  ...
  <link href="{{ asset('public/assets/css/keypad.css') }}" rel="stylesheet">
...
<main id="main">
    ...
    <div class="container-fluid my-card">
      <div class="row">
        <div class="col-xl-8 col-lg-8 col-md-8 ">
          <span class="my-title-camera">QUÉT KHUÔN MẶT</span>
            <div style="height:600px">
              <img class="my-camera-box" src="http://localhost:8000/nhan-dang" style="height: 100%;"> 
        ...
        <div class="col-xl-4 col-lg-4 col-md-4 ">
          <span class="my-title-camera">THÔNG TIN CÔNG DÂN</span>
          ...
          <div class="form-group" style="margin-top: 50px">
            <label for=""> * Trường hợp không nhận dạng khuôn mặt được, công dân vui lòng nhập mã xác nhận bao gồm 8 ký tự nhận được từ email. </label>
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="credits">
        Ứng dụng công nghệ nhận diện khuôn mặt, hỗ trợ dịch vụ công một cửa điện tử. <br>
        CH1801040 - Lý Quang Vũ
      </div>
    </div>
  </footer><!-- End #footer -->
